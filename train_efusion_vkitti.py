...
def __update_model(trainer_engine, batch):
    ...
    imgs, ann, lidar_fov, masks, sparse_depth, k_nn_indices, sparse_depth_gt, basename = batch
...
def __log_validation_results(trainer_engine):
    ...
    with torch.no_grad():
        ...
        for imgs, ann, lidar_fov, masks, sparse_depth, k_nn_indices, sparse_depth_gt, _ in data_loader_train:
